...
const CtaBannerSection = () => {
    return (
        <section
            ...
            className="relative w-full overflow-hidden border-t border-t-secondary/20 border-b border-b-white/[0.06] mt-50 py-20 px-6 bg-linear-to-br from-[#0d1f12] to-background"
        >
